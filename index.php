          ...
          <section class="content__left col-md-8">
            ...
            <div class="block">
              ...
              <div class="block__content">
                ...
                <?php
                  $articles = mysqli_query($connection, "SELECT * FROM `articles` WHERE `categories_id`=11 ORDER BY `id` DESC LIMIT 10")
                ?>
                 <?php
                  while ($art = mysqli_fetch_assoc($articles)) {
                    ?>
            ...
            <div class="block">
              <a href="/articles.php?categories=10">Все записи</a>
              ...
              <div class="block__content">
                ...
                <?php
                  $articles = mysqli_query($connection, "SELECT * FROM `articles` WHERE `categories_id`=10 ORDER BY `id` DESC LIMIT 10")
                ?>
                 <?php
                  while ($art = mysqli_fetch_assoc($articles)) {
                    ?>
